			...
			if(isset($_POST['tipo_comprobante']) && $_POST['tipo_comprobante']!="" &&
				...
				try {
					...
					if(strlen($NCF)==19){
						...
						$querySave="INSERT INTO ssf_facturas_comprobantes";
						$querySave.="(ncf,cliente,rnc,lado,manguera,combustible,volumen,monto,fecha,hora,tarjeta,placa_vehiculo,tipo_ncf,credito) VALUES";
						$querySave.="(:ncf,:cliente,:rnc,:lado,:manguera,:combustible,:volumen,:monto,:fecha,:hora,:tarjeta,:placa_vehiculo,:tipo_ncf,:credito)";
						...
						$resultado=$conexionbd->Ejecutar($conexionPgsql,$querySave,$parametros);
                    	if($resultado=="SI"){
